...
BEGIN
    ...
    INSERT INTO [silver.NCCM].MAPPING_SURROGATE_KEYS_DIMS  WITH (ROWLOCK) (UQ_KEY, UQ_KEY_HASH, DIM_ID, DIMENSION, ROW_CREATED_AT)
    SELECT 
        dm.UQ_KEY,
        dm.UQ_KEY_HASH,
    ...
    INSERT INTO [silver.NCCM].MAPPING_SURROGATE_KEYS_DIMS (UQ_KEY, UQ_KEY_HASH, DIM_ID, DIMENSION, ROW_CREATED_AT)
    SELECT 
        dm.UQ_KEY,
        dm.UQ_KEY_HASH,
